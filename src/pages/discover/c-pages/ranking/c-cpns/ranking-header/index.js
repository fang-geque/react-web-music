...
import FGQSongOperationBar from '@/components/song-operation-bar';
import {
  RankingHeaderWrapper
} from './style';

export default memo(function FGQRankingHeader() {
  // redux
  ...
  return (
    <RankingHeaderWrapper>
      ...
      <div className="info">
        ...
        <FGQSongOperationBar favorTitle={`(${topInfo.subscribedCount})`}
