...
import FGQRadioRankingCover from '@/components/radio-ranking-cover';
...
export default memo(function FGQRadioRanking() {
  // state
  ...
  return (
    <RankingWraper>
      <FGQThemeHeaderNormal title="电台排行榜"/>
      <div className="ranking-list">
        {
          radios.map((item, index) => {
            return (<FGQRadioRankingCover key={item.id} radio={item}/>)
          })
        }
      </div>
